@doc .myw
	...
	This package defines those notations for use in MyWord documents:
	.tsv
	...
	Default syle rules set background colors. The default type of the content is `prose` so CriticMarkup cannot be
	applied at the block level, i.e., across paragraphs.
	
	An example:
	demo
		Don’t go around saying{-- to people that--} the world owes you a living. The world owes you 
		nothing. It was here first.
		
		{~~One~>Only one~~} thing is impossible for God: To find {++any++} sense in any copyright law
		on the planet.
		
		{==Truth is stranger than fiction==}{>>true<<}, but it is because Fiction is obliged to stick to 
